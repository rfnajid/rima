...
return [
     ...
     */
    'base_url' => 'https://rima.rfnaj.id',
    // 'base_url' => 'http://localhost/rima-api/public',
    ...
    'postman' => [
         ...
         */
        'description' => "API untuk mendapatkan Rima dari sebuah kata",
    ],
     ...
     */
    'logo' => public_path().'/images/logo/logo-rima-api-alpha.png',
